...
public class DateTimeProcessing {
    ...
    public static void printOutFuture(LocalDateTime localDateTime) {
        System.out.println("date/time in 5 years will be " + localDateTime);
        System.out.println("date/time in 9 months will be " + localDateTime);
        System.out.println("date/time in 3 weeks will be " + localDateTime);
        System.out.println("date/time in 14 days will be " + localDateTime);
        System.out.println("date/time in 2 hours will be " + localDateTime);
        System.out.println("date/time in 15 minutes will be " + localDateTime);
        System.out.println("date/time in 1000 seconds will be " + localDateTime);
    }
}
